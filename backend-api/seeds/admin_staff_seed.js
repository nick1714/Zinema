...
exports.seed = async function(knex) {
  ...
  if (!adminRole || !staffRole) {
    console.error('Không tìm thấy role admin hoặc staff. Vui lòng seed roles trước.');
    return;
  }
  ...
  async function createUser({ phone, email, password, roleId, fullName, position }) {
  ...
  console.log('Đã seed xong 2 admins, 4 seller và 2 cleaner với mật khẩu mặc định.');
};
