      ...
      <div v-else-if="currentMovie" class="movie-content-card">
        <div class="movie-detail-grid">
          ...
          <div class="form-section">
            <form @submit.prevent class="movie-form">
              <!-- Tiêu đề -->
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <select id="rating" v-model="form.rating" :disabled="true" required>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="date" id="end_date" v-model="form.end_date" :disabled="true" />
                </div>
              </div>
        ...
        <div class="bottom-actions">
           <button v-if="userRole === 'customer'" class="btn-book" @click="handleBookTicket">
...
const statusClass = computed(() => {
  return currentMovie.value?.status === 'active' ? 'status-active' : 'status-inactive'
})

const statusText = computed(() => {
  if (!currentMovie.value) return ''
  return currentMovie.value.status === 'active' ? 'Đang chiếu' : 'Ngừng chiếu'
})
